...
<section class="bg-gradient-to-r from-blue-400 to-indigo-500 dark:from-gray-900 dark:to-gray-800 text-white py-20 md:py-32 transition-colors duration-300">
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <h1 in:fade={{ duration: 1000, delay: 300 }} class="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 tracking-tight">Welcome to Sahara</h1>
    <p in:fade={{ duration: 1000, delay: 600 }} class="text-lg sm:text-xl md:text-2xl mb-10 max-w-3xl mx-auto leading-relaxed">
...
<section class="py-20 bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
  <div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <h2 class="text-3xl sm:text-4xl font-bold mb-12 text-center text-gray-800 dark:text-gray-100 tracking-tight">
      Featured Products
    </h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12">
      {#each products as product, i (product.id)}
        ...
        >
          ...
          <div class="p-6">
            <h3 class="text-xl font-semibold mb-3 text-gray-800 dark:text-gray-100">{product.name}</h3>
