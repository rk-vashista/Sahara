...
<section class="py-16 bg-gray-50 dark:bg-gray-900 transition-colors duration-300 ease-in-out">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 in:fade={{ duration: 300 }} class="text-3xl sm:text-4xl font-extrabold text-gray-800 dark:text-gray-100 mb-12 text-center">Your Cart</h2>

        {#if cartItems.length > 0}
            <div in:fade={{ duration: 300, delay: 150 }} class="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden">
                <table class="w-full text-left">
                    ...
                    <tbody>
                        {#each cartItems as item, i (item.id)}
                            <tr in:fly={{ y: 20, duration: 300, delay: i * 100 }} class="border-t dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
            ...
            <div in:fly={{ y: 20, duration: 300, delay: cartItems.length * 100 }} class="mt-8 text-right">
